...
function invert(color::AbstractRGB)
	return AbstractRGB(1.0 - color.r, 1.0 - color.g, 1.0 - color.b)
end
...
# ╔═╡ 7613ec53-aa12-4c21-bae8-09840067531a
@bind r_slider Slider(0:0.1:1, show_value=true)

# ╔═╡ 87f1f841-7f05-4122-b813-34737755bbff
@bind g_slider Slider(0:0.1:1, show_value=true)

# ╔═╡ 1cd32bdf-cc08-436f-9eb1-29ddf0c965b1
@bind b_slider Slider(0:0.1:1, show_value=true)

# ╔═╡ 91d88fd9-7672-445d-9929-8beabdcc3f79
